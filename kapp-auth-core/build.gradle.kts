...
val frameworkLibraryName    = "KAppAuth" // execute gradle clean after changed it
val libraryArtifact         = "kapp-auth"
val libraryPackage          = "${libraryNamespace}.kapp.auth"
...
android {
    namespace = "io.github.lucasferreiramachado.kapp.auth.core"
