...
import com.lucasferreiramachado.kapp.auth.di.AuthCoordinatorFactory
...
sealed class ExampleCoordinatorAction: KCoordinatorAction {
    data object ShowExampleScreen : ExampleCoordinatorAction()
...
class ExampleCoordinator(
    ...
    override fun handle(action: ExampleCoordinatorAction) {
        when (action) {
            is ExampleCoordinatorAction.ShowExampleScreen -> {
