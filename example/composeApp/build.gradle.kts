...
val frameworkLibraryName    = "KAppAuthCompose" // execute gradle clean after changed it
val libraryArtifact         = "kapp-auth-compose"
val libraryPackage          = "${libraryNamespace}.kapp.auth.compose"
val githubRepoName          = "kapp-auth"
...
//            implementation("io.github.lucasferreiramachado:kapp-auth:1.0.0")
        }
...
android {
    namespace = "com.lucasferreiramachado.kapp.auth.compose"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.lucasferreiramachado.kapp.auth.compose"
...
compose.desktop {
    application {
        mainClass = "com.lucasferreiramachado.kapp.auth.compose.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.lucasferreiramachado.kapp.auth.compose"
